...
export default function BCTViewAllQuizzes() {
  ...
  useEffect(() => {
    const fetchQuizzes = async () => {
      try {
        const response = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/bct-quizzes`);
      ...
      <div className="mb-6 flex space-x-4">
        <label className="flex items-center space-x-2">
          ...
          >
            ...
            <option value="type+subTopic">Question Type + subTopic</option>
          </select>
        </label>
      </div>
