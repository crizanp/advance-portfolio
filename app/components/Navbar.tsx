      ...
      <div className="max-w-7xl mx-auto px-4 text-gray-900">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center md:hidden">
            <button
              onClick={toggleMenu}
              className="text-gray-300 hover:text-gray-400 p-2 rounded-lg transition-colors"
            >
...
const MobileNavLink = ({ href, children, onClick }) => (
  <Link
    href={href}
    onClick={onClick}
    className="block text-gray-300 hover:text-gray-400 px-3 py-2 rounded-md font-medium transition-colors hover:bg-gray-700"
  >
    {children}
  </Link>
);