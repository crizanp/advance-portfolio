          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                <h3 className="text-2xl font-bold mb-3 text-gray-900">325+ Average Score</h3>
                <p className="text-gray-600">Top 5% of test takers</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                <h3 className="text-2xl font-bold mb-3 text-gray-900">10,000+ Questions</h3>
                <p className="text-gray-600">With detailed explanations</p>
              </div>
              <div className="bg-white p-6 rounded-xl shadow-md border border-gray-100">
                <h3 className="text-2xl font-bold mb-3 text-gray-900">Adaptive Learning</h3>
                <p className="text-gray-600">Personalized difficulty adjustment</p>
              </div>
            </div>
          </div>
        </section>
